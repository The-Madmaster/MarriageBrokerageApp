...
INSERT INTO app_users (id, password, email, contact_number, enabled, created_date, last_updated_date, role) VALUES
(1, '$2a$10$XADp6BqcelG9dKU/tFu5E.FelgDQImQXQXOJntChzR2Z99Su8HQkS', 'admin@example.com', '1234567890', TRUE, NOW(), NOW(), 'ROLE_ADMIN');